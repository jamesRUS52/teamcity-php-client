...
class Plugin implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['load_path'] = isset($data['load_path']) ? $data['load_path'] : null;
    ...
    {
        return $this->container['load_path'];
    }

    /**
     * Sets load_path
     *
     * @param string $load_path load_path
     *
     * @return $this
     */
    public function setLoadPath($load_path)
    {
        $this->container['load_path'] = $load_path;
